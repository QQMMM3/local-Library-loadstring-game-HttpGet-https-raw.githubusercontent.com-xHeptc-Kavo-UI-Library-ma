...
Section:NewButton("Fe Floppa", "ButtonInfo", function()
    --[[
    FE floppa
...
Section:NewButton("Pendulum hub v5", "ButtonInfo", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Tescalus/Pendulum-Hubs-Source/main/Pendulum%20Hub%20V5.lua"))()
end)

Section:NewButton("Fe Extendo ", "ButtonInfo", function()
    --Hats needed below:
...
Section:NewButton("Walk on Walls", "ButtonInfo", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/geUZHr7B"))()
end)


Section:NewButton("Syntax X", "ButtonInfo", function()
...
Section:NewButton("Roblox seeeeeeejjjj script but with hats", "ButtonInfo", function()
...
local Tab = Window:NewTab("idk")
local Section = Tab:NewSection("idk scripts")

Section:NewButton("Fe Ball Spin", "ButtonInfo", function()
